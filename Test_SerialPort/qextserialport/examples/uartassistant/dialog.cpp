    ...
    ui(new Ui::Dialog)
{
    ...
    foreach(QextPortInfo port, ports){
        ui->portBox->addItems(QStringList()<<(port.portName));
    }

//    ui->portBox->addItems(QStringList()<<QLatin1String("COM1")<<QLatin1String("COM2")<<QLatin1String("COM3")<<QLatin1String("COM4")<<QLatin1String("COM5")<<QLatin1String("COM6")<<QLatin1String("COM7")<<QLatin1String("COM8")<<QLatin1String("COM9")<<QLatin1String("COM10"));
#else
